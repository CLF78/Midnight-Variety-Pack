...
typedef void (*GT2ConnectAttemptCallback)(GT2Socket sock, GT2Connection conn, u32 ip, u16 port, int latency,
...
typedef void (*GT2DumpCallback)(GT2Socket sock, GT2Connection conn, u32 ip, u16 port, int latency, u8* msg,
                                int msgLen);
